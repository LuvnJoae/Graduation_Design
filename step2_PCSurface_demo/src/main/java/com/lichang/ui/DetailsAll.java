 ...
 * 用于展示 故障 详细信息
 */
public class DetailsAll extends JDialog {
    /**
     * 自定义变量
     */
    ...
    private Map<String, Object> machine_data_brief_map; //工件简要表中根据time查询到的单条信息map。
    ...
    public DetailsAll(Window owner) {
        super(owner);
        initComponents();
    ...
    public DetailsAll(Frame owner, String title, boolean modal) {
    ...
    public DetailsAll(Frame owner, String title, boolean modal, String time) {
        super(owner, title, modal);
        initComponents();
    ...
    private void updateTable1() {
        ...
        //获得 time 相应故障记录
        machine_data_brief_map = DetailsUtil.getBriefRecordForTime(time);

        //非空处理
        if (machine_data_brief_map == null) {
            return;
        }
        ...
        //加载行 内容
        Object[] newRowData = {
                machine_data_brief_map.get("id"),
                machine_data_brief_map.get("time").toString().split("\\.")[0], //去除timestamp后面的 .0
                machine_data_brief_map.get("production_name"),
                machine_data_brief_map.get("production_num"),
                machine_data_brief_map.get("result")
        };
...
//        table2.setDefaultRenderer(Object.class, r);
    ...
    private void updateTable2() {
        ...
        //获取所选产品名称 与 工件编号
        production_name = (String) machine_data_brief_map.get("production_name");
        production_num = (int) machine_data_brief_map.get("production_num");
    ...
    private void initComponents() {
        ...
        scrollPane1.setBounds(0, 0, 985, 50);
